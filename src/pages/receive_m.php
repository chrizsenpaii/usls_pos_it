    ...
    <div class=" h-screen grid grid-cols-5 p-4 gap-4">
            ...
            <main class="col-span-5 bg-white rounded-2xl md:col-span-4 p-4 ">
                ...
                <div class="flex  flex-col gap-4 ">
                    ...
                    <input type="search" name="searchSuppItem" id="searchSuppItem" placeholder="Search..." class="  px-2 py-3 w-56 border-2">
                   <!-- items to add -->
                 <div class="">
                    ...
                    <table class=" table-fixed w-full uppercase text-left  shadow-2xl rounded-2xl border-1  my-4">
                        ...
                        <tbody>
                            <tr class="bg-white border-b">
                                ...
                                <td class="px-2 py-3">11111</td>
                                <td class="px-2 py-3">CET</td>
                                <td class="px-2 py-3">334</td>
                                <td class="px-2 py-3"><input type="date" name="qtyItem" id="qtyItem" class="px-2 py-3 w-24 border-2"></td>
                                <td class="px-2 py-3 flex gap-4 ">
                                   
                                    <i class="fa-solid fa-trash text-2xl px-2 py-3 text-red-600" id="deleteCat"></i>
